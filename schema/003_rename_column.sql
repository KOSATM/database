...
ALTER TABLE hashtag_groups ADD FOREIGN KEY (review_post_id) REFERENCES review_posts(id);
ALTER TABLE hashtags ADD FOREIGN KEY (group_id) REFERENCES hashtag_groups(id);
...
ALTER TABLE ai_styles ADD FOREIGN KEY (review_analysis_id) REFERENCES ai_review_analysis(id);
ALTER TABLE ai_hashtags ADD FOREIGN KEY (review_analysis_id) REFERENCES ai_review_analysis(id);

-- Places & Search
ALTER TABLE image_searches ADD FOREIGN KEY (user_id) REFERENCES users(id);
ALTER TABLE image_search_results ADD FOREIGN KEY (history_id) REFERENCES image_searches(id);
